		...
		if (!get_option('lupercalia_options')) {
			...
			$this->options = array (
				...
				"relatedposts_slider_field" => array (
					...
					"relatedposts_slider_visibleitems_field" => 2,
...
/* ------------------------------------------------------------------------- */	
	...
	function lupercalia_page_init() {
		...
		add_settings_field ('contact_tumblr_field', esc_html__('Tumblr URL', 'lupercalia'), array( $this, 'contact_tumblr_field_callback' ), 'lupercalia_options_page', 'lupercalia_contact_section');
...
/* ------------------------------------------------------------------------- */	
   ...
   public function lupercalia_sanitize( $input ) {
		...
		foreach ( $input['frontpage_branding_field']['slider_url'] as $url ) :
		
			$new_input['frontpage_branding_field']['slider_url'][] = esc_url_raw($url); 
		
		endforeach;	

		foreach ( $input['frontpage_branding_field']['slider_target'] as $target ) :
		
			$new_input['frontpage_branding_field']['slider_target'][] = $target; 
		...
		$new_input['contact_tumblr_field'] = ($input['contact_tumblr_field']) ? esc_url_raw($input['contact_tumblr_field']) : '';
...
/* ------------------------------------------------------------------------- */	
	...
	function general_logo_field_callback() {
        ...
        printf(
            '<input type="text" name="lupercalia_options[general_logo_field]" size="80" class="logo_image" value="%1$s" placeholder="%2$s" />',
            isset( $this->options['general_logo_field'] ) ? stripslashes(( $this->options['general_logo_field'])) : '', esc_html__('Click on Upload Logo button to upload your logo', 'lupercalia')
        );	
	?>
...
/* ------------------------------------------------------------------------- */	
	...
	function frontpage_branding_field_callback() { ?>
		...
		<?php for ($i = 0; $i < $arrayimg; $i++) : ?>
			...
			<br />
				<label for="p_scnts"><input type="text" id="p_scnt" size="80" name="lupercalia_options[frontpage_branding_field][slider_desc][<?php echo $i ?>]" value="<?php echo $this->options['frontpage_branding_field']['slider_desc'][$i] ?>" placeholder="Input Value" /></label> 
			<br />
				<label for="p_scnts"><input type="text" id="p_scnt" size="69" name="lupercalia_options[frontpage_branding_field][slider_url][<?php echo $i ?>]" value="<?php echo $this->options['frontpage_branding_field']['slider_url'][$i] ?>" placeholder="Input Value" />
				<select name="lupercalia_options[frontpage_branding_field][slider_target][<?php echo $i ?>]" id="lupercalia_options[frontpage_branding_field][slider_target][<?php echo $i ?>]">
					<option class="level-0" value="_self" <?php selected($this->options['frontpage_branding_field']['slider_target'][$i], '_self' ); ?>>_self</option>
					<option class="level-0" value="_blank" <?php selected($this->options['frontpage_branding_field']['slider_target'][$i], '_blank' ); ?>>_blank</option>
				</select> 	
				</label> <a href="#" id="remScnt"><?php esc_html_e('Remove item', 'lupercalia'); ?></a>
			</p>		
...
/* ------------------------------------------------------------------------- */	
	...
	function contact_facebook_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_facebook_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.facebook.com/username-or-page', 'lupercalia'),
	...
	function contact_flickr_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_flickr_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.flickr.com/photos/username', 'lupercalia'),
	...
	function contact_googleplus_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_googleplus_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.plus.google.com/user-number', 'lupercalia'),
	...
	function contact_instagram_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_instagram_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.instagram.com/username', 'lupercalia'),
	...
	function contact_linkedin_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_linkedin_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.linkedin.com/profile/view?id=id-number', 'lupercalia'),
	...
	function contact_pinterest_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_pinterest_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.pinterest.com/username', 'lupercalia'),
	...
	function contact_twitter_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_twitter_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.twitter.com/username', 'lupercalia'),
            isset( $this->options['contact_twitter_field'] ) ? esc_attr( $this->options['contact_twitter_field']) : ''
        );		
	}
	function contact_tumblr_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_tumblr_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('username.tumblr.com', 'lupercalia'),
            isset( $this->options['contact_tumblr_field'] ) ? esc_attr( $this->options['contact_tumblr_field']) : ''
        );		
	}		
	function contact_vimeo_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_vimeo_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.vimeo.com/user-number', 'lupercalia'),
            isset( $this->options['contact_vimeo_field'] ) ? esc_attr( $this->options['contact_vimeo_field']) : ''
        );		
	}
	function contact_youtube_field_callback() {
        printf(
            '<input type="text" name="lupercalia_options[contact_youtube_field]" size="80" placeholder="%1$s" value="%2$s" />', esc_html__('www.youtube.com/user/username', 'lupercalia'),
