...
/* ==========================================================================
   ...
   ========================================================================== */	
	...
	jQuery('#addScnt').live('click', function() {
		jQuery('<p><label for="p_scnts"><input type="text" id="p_scnt" size="80" name="lupercalia_options[frontpage_branding_field][slider_image][' + i + ']" value="Slider ' + i + ' Image" class="slider_image_' + i + '" /> <input type="submit" class="button sliderbutton" id="' + i + '" value="Upload Image" /> </label><br /><label for="p_scnts"><input type="text" id="p_scnt" size="80" name="lupercalia_options[frontpage_branding_field][slider_title][' + i + ']" value="Slider ' + i + ' title" /></label><br /><label for="p_scnts"><input type="text" id="p_scnt" size="80" name="lupercalia_options[frontpage_branding_field][slider_desc][' + i + ']" value="Slider ' + i + ' Decription" /></label><br /><label for="p_scnts"><input type="text" id="p_scnt" size="69" name="lupercalia_options[frontpage_branding_field][slider_url][' + i + ']" value="Slider ' + i + ' url" /><select name="lupercalia_options[frontpage_branding_field][slider_target][' + i + ']" id="lupercalia_options[frontpage_branding_field][slider_target][' + i + ']"><option class="level-0" value="_self">_self</option><option class="level-0" value="_blank">_blank</option></select> </label> <a href="#" id="remScnt">Remove item</a></p>').appendTo(scntDiv);
		i++;
			return false;
	});
